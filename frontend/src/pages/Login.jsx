...
const Login = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-blue-50 flex items-center justify-center p-4 sm:p-8">
            <div className="bg-white w-full max-w-5xl rounded-[40px] shadow-2xl overflow-hidden flex min-h-[600px]">
                ...
                <div className="w-full lg:w-1/2 p-8 sm:p-16 flex flex-col justify-center">
                    <div className="mb-10">
                        ...
                        <h1 className="text-4xl font-bold text-slate-800 mb-4">Login</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Link to="#" className="text-sm text-blue-500 hover:text-blue-700 font-semibold">Forgot Password?</Link>
                        </div>

                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-xl text-sm px-5 py-4 text-center transition-all shadow-lg shadow-blue-500/30 flex justify-center items-center"
                        >
                ...
                <div className="hidden lg:flex w-1/2 bg-blue-600 p-12 flex-col justify-center items-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 w-full max-w-md">
                        <img src="/assets/auth_illustration.png" alt="Login Illustration" className="w-full h-auto drop-shadow-2xl rounded-2xl" />
                    </div>

                    <div className="relative z-10 mt-12 text-center text-white">
                        <h2 className="text-3xl font-bold mb-4">Manage Your Tasks Efficiently</h2>
                        <p className="text-blue-100 opacity-80">Streamline your workflow, collaborate with your team, and achieve your goals with our powerful platform.</p>
                    </div>
                </div>
            </div>
        </div>
